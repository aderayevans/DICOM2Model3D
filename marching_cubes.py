...
class MarchingCubes:
    ...
    @staticmethod
    def marching_cubes_single_cube(v4, v3, v1, v2, v8, v7, v5, v6, threshold=0):
        pass


    @staticmethod
    def marching_cubes(images, threshold=0):
        # test_images = images[0:20]
        test_images = [
            [
                [0, 1],
                [0, 0],
        ...
        # test 1 cube
        xmin = 0
        xmax = len(test_images[0][0])
        ymin = 0
        ymax = len(test_images[0])
        zmin = 0
        zmax = len(test_images)
        for z in range(zmin, zmax):
            for y in range(ymin, ymax):
                for x in range(xmin, xmax):
                    print("x: {}, y: {}, z: {} >> {}".format(x, y, z, test_images[z][y][x]))
                    vert = Vertex(x, y, z)
                    marching_cubes_single_cube()
...
if __name__ == '__main__':
    MarchingCubes.marching_cubes(None, 0)
